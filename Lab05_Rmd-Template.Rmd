...
plot_recoveryYear_nonspat <- ggplot(
...
plot_recoveryYear_ras <- ggplot() +
  geom_spatraster(
    data = recovery_result_ras_plot
  ) +
  #scale_fill_discrete(na.translate = FALSE) +
  scale_fill_manual(
    values        = c(colorRampPalette(c("white", "red"))(length(levels(factor(values(recovery_result_ras_plot))))-2), "black"),
    na.translate  = FALSE,
    name          = "Recovery year"
  )

plot_recoveryYear_ras
```
